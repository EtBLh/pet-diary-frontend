...
const InputRow = ({ label, placeholder }) => {
  return (
    <View style={styles.inputRow}>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          // Add other TextInput related props as needed
        />
      </View>
...
const PetDiaryPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* 輸入選項區 */}
      <InputRow label="Name" placeholder="Enter" />
      <InputRow label="Age" placeholder="Enter" />
      <InputRow label="Breeds" placeholder="Enter" />
